...
def topic_filter(user_input: str) -> bool:
    ...
    greetings = ["hi", "hello", "hey", "xin chao", "xin chào", "chào", "chao"]
    for greet in greetings:
        if greet == input_lower.strip():
            return False
        ...
        *,
        ...
        if detect_injection(text):
            ...
            return self._block_response(
                "I cannot process that request. For security reasons, I am not allowed to reveal system instructions or internal details."
            )
